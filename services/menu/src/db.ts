...
async function ensureSeed(): Promise<void> {
  ...
  await sql`
    INSERT INTO menu_items (id, name, price_cents) VALUES
      ('44444444-4444-4444-4444-444444444444', 'Gyros', 1100),
      ('55555555-5555-5555-5555-555555555555', 'Souvlaki', 1300),
      ('66666666-6666-6666-6666-666666666666', 'Greek Salad', 900),
      ('77777777-7777-7777-7777-777777777777', 'Moussaka', 1400)
  `;
}
